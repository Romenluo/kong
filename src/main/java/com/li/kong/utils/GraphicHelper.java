...
public final class GraphicHelper {
	...
	private static final Color[] COLORS = { Color.BLUE,Color.GRAY,Color.GREEN,Color.RED, Color.BLACK,Color.ORANGE,Color.CYAN ,Color.PINK , Color.MAGENTA };
	...
	public static final String create( final int n , boolean isSinaean , final int width,final int height , OutputStream output , final int interfere ){
		...
		// 设置字体样式
		if( isSinaean ) {
			graphic.setFont(new Font("微软雅黑",Font.BOLD,30));
		} else {
